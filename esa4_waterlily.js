function renderWaterlily(display_lines){

    // Get the WebGL context.
    var canvas = document.getElementById('waterlily');
    ...
    for (var i = 0, u = 0; i <= n; i++, u += du) {
        ...
        for (var j = 0, v = 0; j <= m; j++, v += dv) {
            ...
            var y = -( 2 * v / Math.PI - Math.cos(v)) * 0.2 - 0.6;
            var x = -(1.5 * Math.sin(u+5) * Math.sin(v)) * 0.25;
            var z = 0.6;
            ...
            if (j > 18) {
                colors[iVertex * 3] = 0.5 / vertexLength;
                colors[iVertex * 3 + 1] = y / vertexLength;
                colors[iVertex * 3 + 2] = 0.3 / vertexLength;
            } else {
                colors[iVertex * 3] = 0.5;
                colors[iVertex * 3 + 1] = 1;
                colors[iVertex * 3 + 2] = 0.5;
            }
